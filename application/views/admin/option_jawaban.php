...
<h3>Setting Menjawab Aduan </h3>
<form class="well" role="form" method="POST" action="<?php echo site_url('admin/option_jawaban'); ?>">
    ...
    <div class="form-group">
        <p>
        	<?php if ($nilai_option == 0) {?>
            	<input type="radio" name="nilai_option" value="0" checked> Sekali
            	<br>
            	<input type="radio" name="nilai_option" value="1"> Beberapa Kali
            <?php } else {?>
			  	
			  	<input type="radio" name="nilai_option" value="0" > Sekali
			  	<br>
				<input type="radio" name="nilai_option" value="1" checked> Beberapa Kali
			<?php } ?>
        </p>
    </div>
