...
<ul class="nav nav-pills">
	<li>
		<input align="center" style="width: 200px; color: black;" type="submit" class="active btn btn-default" name="aduan" id="aduan" value="Aduan" />	
...
<table id="list_aduan" class="table ukuran bordTabel">
	<thead>
		<tr class="as">
			<th>Nomor Aduan</th>
			<th>Nama</th>
