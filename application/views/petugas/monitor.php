...
<ul class="nav nav-pills">
	...
	<li>
		...
		<input align="center" style="width: 200px; color: black;" type="submit" class="btn btn-default" name="arsip" id="arsip" value="Arsip" />
		<input align="center" style="width: 200px; color: black;" type="submit" class="active btn btn-default" name="monitor" id="monitor" value="Monitoring" />
...
$(document).ready(function(){
    	...
    	var $ol = $('#tahun');
       	...
       	//var x = $el.val();
       	var title = $el.val();
       	$('#text_keyword').html('<input style="height:23px; width: 100%;" type="text" id="'+title+'" placeholder="masukkan keyword " />');
